      ...
      <main className="pt-16">
        <section className="relative h-80 overflow-hidden">
          ...
          <div className="relative z-10 h-full flex flex-col justify-center px-8 max-w-7xl mx-auto">
            <span className="bg-[#D4AF37] text-[#023E8A] text-xs font-bold px-3 py-1 rounded-full w-fit mb-3">Boutique & Salon</span>
        ...
        {settings.abaam_description && (
          <section className="bg-white py-10">
            <div className="max-w-3xl mx-auto px-4 sm:px-6 text-center">
              <p className="text-gray-600 leading-relaxed text-base">{settings.abaam_description}</p>
            </div>
          </section>
        )}
          ...
          {settings.abaam_salon_banner_url && (
            <div className="relative h-64 overflow-hidden">
              <SupabaseImage
                ...
                className="object-cover object-center"
              />
              <div className="absolute inset-0 bg-gradient-to-r from-[#023E8A]/70 to-[#0077B6]/40" />
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-center">
                  <div className="inline-flex items-center gap-2 bg-[#D4AF37]/20 border border-[#D4AF37]/50 text-[#D4AF37] text-xs font-bold px-4 py-1.5 rounded-full mb-3">
          ...
          <div className="max-w-5xl mx-auto px-4 py-16">
            ...
            {!settings.abaam_salon_banner_url && (
              <div className="flex items-center gap-3 mb-2">
                <div className="w-10 h-10 bg-[#0077B6]/10 rounded-full flex items-center justify-center shrink-0">
                  <Scissors size={20} className="text-[#0077B6]" />
                </div>
                <h2 className="font-playfair text-3xl font-bold text-[#023E8A]">Visit Our Salon</h2>
              </div>
            )}
            {settings.abaam_salon_banner_url && (
              <h2 className="font-playfair text-3xl font-bold text-[#023E8A] mb-2">Visit Our Salon</h2>
            )}
            <div className="w-12 h-1 bg-[#D4AF37] rounded-full mb-6" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-start">
              ...
              <div>
                ...
                <div className="space-y-3 mb-8">
                  {settings.abaam_salon_hours && (
                    <div className="flex items-center gap-3 text-sm text-gray-600">
                      <div className="w-8 h-8 bg-[#0077B6]/10 rounded-full flex items-center justify-center shrink-0">
                  ...
                  <div className="flex items-center gap-3 text-sm text-gray-600">
                    ...
                    <a href={`tel:${settings.abaam_salon_whatsapp || settings.phone_number || "0594299293"}`} className="hover:text-[#0077B6] transition-colors">
                ...
                <div className="flex flex-wrap gap-3">
                  <Link href="/salon" className="inline-flex items-center gap-2 bg-[#0077B6] text-white px-5 py-2.5 rounded-lg font-semibold hover:bg-[#023E8A] transition-colors">
                  ...
                  {(settings.abaam_salon_whatsapp || settings.phone_number) && (
                    <a
                      ...
                      className="inline-flex items-center gap-2 bg-[#25D366] text-white px-5 py-2.5 rounded-lg font-semibold hover:bg-[#1da851] transition-colors"
                    >
              ...
              {(settings.abaam_salon_featured_1 || settings.abaam_salon_featured_2 || settings.abaam_salon_featured_3) ? (
                ...
                <div className="grid grid-cols-2 gap-3">
                  {[1, 2, 3].map((n) => (
                    <div key={n} className={`relative ${n === 1 ? "col-span-2 h-48" : "h-36"} rounded-xl border-2 border-dashed border-[#0077B6]/20 bg-[#F8F9FA] flex items-center justify-center`}>
