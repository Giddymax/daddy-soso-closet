            ...
            <div className="space-y-3">
              {branches.map((b) => (
                <button
                  ...
                  className="w-full flex items-center justify-between px-4 py-3.5 rounded-xl border border-stone-200 hover:border-[#0077B6] hover:bg-[#0077B6]/5 transition-all group text-left"
                >
                  <div>
                  ...
                  <ChevronRight size={16} className="text-stone-300 group-hover:text-[#0077B6] transition-colors" />
                </button>
              ))}
            </div>
            <div className="mt-4 pt-4 border-t border-stone-100">
              <Link href="/admin" className="block text-center text-xs text-[#D4AF37] hover:underline font-medium">
      ...
      >
        ...
        <div className="px-6 py-4 border-b border-white/10">
          ...
          <div className="flex items-center gap-1.5 mt-1 flex-wrap">
            <span className="inline-block bg-[#D4AF37] text-white text-xs font-bold px-2 py-0.5 rounded-full">
